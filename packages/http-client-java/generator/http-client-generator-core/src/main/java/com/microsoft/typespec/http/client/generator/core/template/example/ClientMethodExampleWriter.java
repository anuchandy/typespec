...
import com.microsoft.typespec.http.client.generator.core.mapper.MethodParameterTransformer.Mapping;
...
public class ClientMethodExampleWriter {
    ...
    private ExampleNode parseNodeFromParameter(ClientMethod convenienceMethod, ProxyMethodExample proxyMethodExample,
        ...
        if (isGroupingParameter(convenienceMethod, methodParameter)) {
            ...
            for (ParameterTransformation detail : convenienceMethod.getParameterTransformations()) {
                for (Mapping parameterMapping : detail.getParameterMappings()) {
            ...
            ClientMethodParameter outputParameter
                = convenienceMethod.getParameterTransformations().iterator().next().getOutParameter();
            ...
            Mapping parameterMapping = convenienceMethod.getParameterTransformations()
                .iterator()
                .next()
